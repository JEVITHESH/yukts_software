...
sp = SystemPrompt("yukta", "Create an agent that can analyze stock data and provide investment advice.")
...
print(llm1.get_model_info())  # Fetch and print model info to verify connection and capabilities
